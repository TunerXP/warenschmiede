...
function app(){ return {
  appVersion:'1.9.5',
  settingsOpen:false, settingsNotice:'', highlightedProfileId:'', historyOpen:false, preflightOpen:false, historyNotice:'', historySearch:'', historyDateFilter:'all', historySort:'newest', activeTab:'firma', tabs:[{id:'firma',label:'Firma'},{id:'design',label:'Logo & Design'},{id:'zahlung',label:'Zahlung'},{id:'steuer',label:'Steuer'},{id:'presets',label:'Presets'},{id:'qr',label:'QR-Code'},{id:'ausgabe',label:'Ausgabe'},{id:'daten',label:'Daten'}],
  ...
  reapplyProfile(job){ this.applyProfile(job); this.showSettingsNotice('Profilwerte wurden in die Position neu übernommen.'); },
